...
const fs = require("fs");
const generateHeaders = (cookies, channel) => {
    ...
    const newHash = timesec + "_" + sha1(timesec + " " + SAPISID + " " + origin, "utf8", "hex");
    ...
    let headers = {
        ...
        "X-Goog-Authuser": "0",
        "X-Goog-Visitor-Id": "unique-google-authenticator-id-.-it-is-generated-when-loging-in-google",
        ...
        ":method": "POST",
        ":path": "/youtubei/v1/subscription/subscribe?key=AIzaSyAO_FJ2SlqU8Q4STEHLGCilw_Y9_11qcW8&prettyPrint=false",
        ":scheme": "https",
        Accept: "*/*",
...
const subscribe = (cookies, key, channel) => __awaiter(this, void 0, void 0, function* () {
    if (!cookies || !cookies.length)
        throw new Error("There re no cookies defined.");
    if (!key)
        throw new Error("Key defined is not valid.");
